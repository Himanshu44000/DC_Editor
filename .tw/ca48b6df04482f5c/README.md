...
- Browser/cloud terminal with PowerShell: .\start.ps1
- If PowerShell policy blocks scripts: powershell -ExecutionPolicy Bypass -File .\start.ps1
- Browser/cloud terminal with cmd shell: .\start.bat
...
By default, dependency installation is quiet (less noisy logs).
To see full pip logs, set FASTAPI_VERBOSE=1 before running the script.
